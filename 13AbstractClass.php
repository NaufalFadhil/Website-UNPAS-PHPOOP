...
// BUAT CLASS ABSTARCT KARENA TIDAK AKAN PERNAH DI INSTANSIASI
abstract class Produk
{
    ...
    // INI METHOD ABSTRACT SEBAGAI SYARAT MINIMUM KARENA CHILD MENGGUNAKAN INI
...
// $produk = new produk(); // INI GA AKAN BISA
